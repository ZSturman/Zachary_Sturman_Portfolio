...
tip_redistribution_proj = Project("Examining the Effectiveness of Tip Redistributing in the Casino Industry", "A Data-Driven Approach Revisiting The Impact of Current Tipping Practices", "In this case study, we delve into the effectiveness of tip redistributing within the casino industry, exploring its impact on employee satisfaction, customer experience, and overall business performance. We analyze various tip pooling and sharing systems, while considering the unique dynamics present in the highly competitive and service-oriented casino environment. Through a comprehensive examination of employee perspectives, customer feedback, and financial outcomes, we aim to uncover insights that can guide the industry towards better practices and enhanced employee welfare.", "January 2023", link=None, url_for='projects.tip_redistribution', link_title="View Case Study", image="static/images/projects/tip_redistribution.png", alt="Tip Redistribution Image", tags=["Case Study", "Data Analysis", "ChartJS", "Business intelligence"])

periodic_table_proj = Project("Interactive Periodic Table of Elements", "Explore, Discover, and Engage with the Building Blocks of Matter", "This interactive periodic table of elements app is designed to spark your curiosity and deepen your understanding of the building blocks of matter. Dive into the world of elements as you explore detailed information, captivating visuals, and engaging activities tailored to users of all ages and backgrounds. Discover the unique properties, history, and real-life applications of each element as you navigate through our user-friendly interface. Unleash your inner scientist and embark on a journey to unlock the secrets of the universe, one element at a time.", "January 2023", link=None, url_for='projects.periodic_table', link_title="Go To Table", image="static/images/projects/periodic_table.png", alt="Periodic Table Image", tags=["Interactive", "UI", "UX", "Database Management"])
